...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
	...
	{
		// Create the vertex shader
		if (g_pd3dDevice->CreateVertexShader(ImGuiVS, sizeof(ImGuiVS), NULL, &g_pVertexShader) != S_OK)
		{
			return false;
		}
		...
		if (g_pd3dDevice->CreateInputLayout(local_layout, 3, ImGuiVS, sizeof(ImGuiVS), &g_pInputLayout) != S_OK)
		{
			return false;
		}
		// Create the constant buffer
		...
		// Create the pixel shader
		if (g_pd3dDevice->CreatePixelShader(ImGuiPS, sizeof(ImGuiPS), NULL, &g_pPixelShader) != S_OK)
		{
			return false;
		}
	}
