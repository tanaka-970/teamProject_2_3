...
//
// Frames が増えない
//     -> Update が呼ばれていない（インスタンスが作られていない）
// Frames は増えるが MoveOk が 0
//     -> Update は動くが Runtime API が失敗している。LastStatus を見る
// 両方増えるのに見た目が変わらない
//     -> 他の Component が位置を上書きしている（Character Motor など）
//
...
public sealed class MoveTest : ScriptBehaviour
{
    ...
    public override void Update(float deltaTime)
    {
        ...
        //
        // 読み取ってから足す書き方だと、読み取りが失敗したときに
        // 何も起きず「動いていない」のと見分けが付かなくなる。
        ...
        // 回転も付ける。位置が他の Component に打ち消されても、
        // 回っていれば Update が動いていることは分かる。
