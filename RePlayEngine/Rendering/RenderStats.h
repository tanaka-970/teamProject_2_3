...
namespace ReplayEngine::Rendering
{
    ...
    public:
        ...
        static constexpr std::size_t phase_count = static_cast<std::size_t>(Phase::Count);
        ...
        static constexpr std::size_t state_kind_count = static_cast<std::size_t>(StateKind::Count);
        ...
        struct ExternalGpuPassTiming
        {
            std::string name;
            Phase phase = Phase::Scene3D;
        ...
        {
        public:
            explicit ScopedCpu(const char* name) noexcept;
            ~ScopedCpu() noexcept;
        ...
        std::uint64_t BeginScope(const char* name) noexcept;
        void EndScope(std::uint64_t token) noexcept;
        void ApplyExternalGpuTiming(std::uint64_t source_frame_id,
        ...
        std::size_t PendingGpuFrames() const noexcept { return pending_external_gpu_frames_; }
    ...
    private:
        ...
        std::uint64_t latest_external_gpu_source_frame_ = 0;
        std::size_t pending_external_gpu_frames_ = 0;
